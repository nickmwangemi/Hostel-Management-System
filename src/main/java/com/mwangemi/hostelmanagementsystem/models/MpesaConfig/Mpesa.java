package com.mwangemi.hostelmanagementsystem.models.MpesaConfig;
...
public class Mpesa {
    ...
    public Mpesa(String appKey, String appSecret) {
        this.appKey = appKey;
    ...
    public String STKPushSimulation(StkRequest stkRequest) throws IOException {
        JSONArray jsonArray=new JSONArray();
        JSONObject jsonObject=new JSONObject();
        jsonObject.put("BusinessShortCode", stkRequest.getBusinessShortCode());
        jsonObject.put("Password", stkRequest.getPassword());
        jsonObject.put("Timestamp", stkRequest.getTimestamp());
        jsonObject.put("TransactionType", stkRequest.getTransactionType());
        jsonObject.put("Amount",stkRequest.getAmount());
        jsonObject.put("PhoneNumber", stkRequest.getPhoneNumber());
        jsonObject.put("PartyA", stkRequest.getPartyA());
        jsonObject.put("PartyB", stkRequest.getPartyB());
        jsonObject.put("CallBackURL", stkRequest.getCallBackURL());
        jsonObject.put("AccountReference", stkRequest.getAccountReference());
        jsonObject.put("QueueTimeOutURL", stkRequest.getQueueTimeOutURL());
